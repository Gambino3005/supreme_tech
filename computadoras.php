    ...
    <div class="container" id="main">
       ...
       <div class="row">
               <?php
                 ...
                 $pelicula = new Kawschool\Computadoras;
           ...
           <footer class="bd-footer py-5 mt-5 bg-light" style="background-color: #0B243B; color:white;">
  <div class="container py-5">
    <div class="row">
      ...
      <div class="col-md-4">
       <h4>Contactanos</h4>
        <ul class="list-unstyled">
          <li class="mb-2"><p>Tel.: (849-225-2004)</p></li><br>
          <li class="mb-2"><p>Fax: (849-250-2040)</p></li><br>
          <li class="mb-2"><p>supremetech@gmail.com</p></li>
      ...
      <div class="col-md-4">
        ...
        <ul class="list-unstyled">
        <li class="mb-2"><a href="nosotros.php" style="text-decoration:none; color:white;">Acerca de Supreme Tech</a></li> <br>
        <li class="mb-2"><a href="#" style="text-decoration:none; color:white;">Ubicaciones</a></li><br>
        <li class="mb-2"><a href="#" style="text-decoration:none; color:white;">Inversionistas relacionados</a></li>
        </ul>
      </div>
      <div class="col-md-4">
        <h4>Siguenos</h4>
        <ul class="list-unstyled">
        <a href="#" style="text-decoration:none; color:white"><svg xmlns="http://www.w3.org/2000/svg" width="17" height="17" fill="currentColor" class="bi bi-facebook" viewBox="0 0 16 16">
